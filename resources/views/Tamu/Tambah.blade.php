...
<div class="main-content">
    ...
    <div class="card-tambah-tamu">
        <form action="{{ route('tamu.sumbit') }}" method="post">
            @csrf
            <div class="row g-0">
                <div class=" col-md-7">
                    ...
                    <div class="row g-3 align-items-center"
                        ...
                        <div class="col-auto">
                            <input type="text" name="nama" class="form-control" autocomplete="off"  style="width: 450px;">
                        </div>
                    </div>
                    ...
                    <div class="row g-3 align-items-center" style="margin-left:8px; margin-bottom:20px;">
                        ...
                        <div class="col-auto" style="margin-left: 10px">
                            <input type="text" name="no_hp" class="form-control" autocomplete="off"  style="width: 450px">
                        </div>
                    </div>
